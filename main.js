...
📲 Para jugar ingrese aquí: https://casinozeus.io/`;
...
📱 *PLATAFORMA:* https://casinozeus.io/
...
💻 Nuestra plataforma es https://casinozeus.io/
...
solicitoUsuario.addEventListener("click", () => {
  const texto = `Por favor *SIEMPRE* envie su usuario debajo del comprobante para poder cargar las fichas 🙏🏼`;
  const elementoTemporal = document.createElement("textarea");
  elementoTemporal.value = texto;
  document.body.appendChild(elementoTemporal);
  elementoTemporal.select();
